...
- **Problem Solver**: Simplifies the creation of residential lease agreements
- **Learning Project**: Built as a hands-on study of React Native and Expo
- **Open Source**: Free for anyone to use, modify, and learn from

## 🔒 Privacy First

The app is designed to run **100% locally and offline**:
