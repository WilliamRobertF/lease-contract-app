...
export const DEFAULT_CLAUSES: Clause[] = [
  ...
  {
    id: 'clause-16',
    title: 'Responsabilidade por Fenômenos Naturais',
  ...
  },
  {
    ...
    content: `As partes contratantes obrigam-se por si, herdeiros e/ou sucessores, elegendo o Foro da Cidade de ${"{CITY}"}, para o processamento de qualquer ação oriunda da presente avença, renunciando a qualquer outro.`,
  },
];
